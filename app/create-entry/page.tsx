...
export default function CreateEntryPage() {
  ...
  const submit = (event: React.FormEvent) => {
    ...
    window.setTimeout(() => { const entry = saveEntry({ id: editId ?? undefined, type, title: title.trim(), body: body.trim(), happenedAt: date, author: "Bapak", photos: normalizedPhotos }); setSaving(false); setToast("Cerita tersimpan"); window.setTimeout(() => router.push(`/entry/${entry.id}`), 500); }, 550);
  };
