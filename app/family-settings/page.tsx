...
export default function FamilySettingsPage() {
  ...
  const { familyName, child, partnerEmail, partnerStatus, updateFamilyName, resetDemo, startExport, exportStatus } = useDemo();
