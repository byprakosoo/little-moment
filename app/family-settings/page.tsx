...
export default function FamilySettingsPage() {
  ...
  const { familyName, child, partnerEmail, updateFamilyName, resetDemo, setForcedState, startExport, exportStatus } = useDemo();
