...
export default function FamilySettingsPage() {
  ...
  const { familyName, child, partnerEmail, partnerStatus, membershipRole, updateFamilyName, signOut, leaveFamily, startExport, exportStatus } = useDemo();
