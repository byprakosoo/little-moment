...
import { ArrowRight, Check, DownloadSimple, LockKey, SignOut, UserPlus } from "@phosphor-icons/react";
...
export default function FamilySettingsPage() {
  ...
  const { familyName, ownerLabel, memberLabel, ownerEmail, partnerEmail, partnerStatus, membershipRole, updateFamilyProfile, signOut, leaveFamily, startExport, exportStatus } = useDemo();
  ...
  }, [familyName, ownerLabel, memberLabel]);
  ...
  const saveFamilyProfile = async (event: React.FormEvent) => {
    ...
    try {
      await updateFamilyProfile({ name, ownerLabel: nextOwnerLabel, memberLabel: nextMemberLabel });
